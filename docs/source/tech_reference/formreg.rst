...
Process
 - Calculate summary score for every gage within the VPU that has calibration stats.
 ...
 - Select best formulation at each gage.
 ...
 - Optimal formulations are then assigned to all nextgen divides upstream of a given gage.
 - Divides are aggregated by spatial unit specified in spatial_unit.huc_level in config_formreg.yaml
 - An optimal formulation is then selected for the spatial unit.
 ...
 - Assign formulations to calibrated basins.
